...
const documents = ref([
  ...
  },
  {
    ...
    extractedText: '<h1>Nokia`s Technological Evolution</h1> <h2>Embracing the Metaverse</h2><p>Nokia`s metamorphosis epitomizes a quintessential paradigm shift. The company`s strategic initiatives encompass a plethora of multifaceted endeavors, each contributing to its overarching objective of technological preeminence.</p><h2>Advancements in Web3 and Blockchain</h2><p>Concurrently, Nokia is delving into the realm of Web3, a decentralized iteration of the internet predicated on blockchain technology. This initiative underscores the company`s dedication to fostering a more egalitarian digital ecosystem, wherein data sovereignty and user autonomy are paramount. The esoteric nature of blockchain integration presents a labyrinthine challenge, yet Nokia`s resolve remains unwavering.</p><h2>Artificial Intelligence Integration</h2><p>In the domain of artificial intelligence, Nokia is orchestrating the integration of machine learning algorithms into its network operations. This stratagem aims to augment operational efficiency through predictive analytics and automated optimization. The convolution inherent in training and deploying such algorithms is indicative of the company`s proclivity for embracing complexity in pursuit of innovation.</p> <h2>Lunar Connectivity Initiatives</h2><p>Moreover, Nokia`s collaboration with NASA to establish a lunar 4G LTE network exemplifies its audacious aspirations. This project entails the deployment of resilient communication infrastructures capable of withstanding the Moon`s inhospitable environment. The endeavor`s technical exigencies are formidable, yet they epitomize Nokia`s relentless pursuit of expanding the frontiers of connectivity.</p><h2>Conclusion</h2><p>In summation, Nokia`s multifarious initiatives delineate a trajectory replete with complexity and innovation. The company`s unwavering commitment to advancing technological paradigms underscores its role as a vanguard in the ever-evolving digital landscape.</p>',
  },
  {
    id: 3,
    fileName: 'Dyslexia',
